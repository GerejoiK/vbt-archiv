<script>
	...
	let battle = jq(`${$page.params.turnier}.runden.${$page.params.runde}.battles.${$page.params.battle}`, {
		data: turniere,
	});
	$: battle = jq(`${$page.params.turnier}.runden.${$page.params.runde}.battles.${$page.params.battle}`, {
		data: turniere,
	});
</script>
